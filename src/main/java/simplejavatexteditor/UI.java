...
public class UI extends JFrame implements ActionListener {
    ...
    private final ImageIcon boldIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/bold.png"));
    private final ImageIcon italicIcon = new ImageIcon("icons/italic.png");

    // setup icons - File Menu
    private final ImageIcon newIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/new.png"));
    private final ImageIcon openIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/open.png"));
    private final ImageIcon saveIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/save.png"));
    private final ImageIcon closeIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/close.png"));

    // setup icons - Edit Menu
    private final ImageIcon clearIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/clear.png"));
    private final ImageIcon cutIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/cut.png"));
    private final ImageIcon copyIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/copy.png"));
    private final ImageIcon pasteIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/paste.png"));
    private final ImageIcon selectAllIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/selectall.png"));
    private final ImageIcon wordwrapIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/wordwrap.png"));

    // setup icons - Search Menu
    private final ImageIcon searchIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/search.png"));

    // setup icons - Help Menu
    private final ImageIcon aboutMeIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/about_me.png"));
    private final ImageIcon aboutIcon = new ImageIcon(UI.class.getClassLoader().getResource("icons/about.png"));
    ...
    public UI() {
        try {
            ImageIcon image = new ImageIcon(UI.class.getClassLoader().getResource("icons/ste.png"));
